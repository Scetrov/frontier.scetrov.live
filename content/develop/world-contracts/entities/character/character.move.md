...
> [!TIP]
> `character` can be considered to be the Identity part of Identity and Access Management (IdAM); with [`access`](/develop/world-contracts/access/access_control.move/) representing the Access Control part of Identity and Access Management.
