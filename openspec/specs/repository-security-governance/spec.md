...
## Purpose
Define repository governance and vulnerability-reporting requirements appropriate to the project's maintainer model and intentional security exceptions.
